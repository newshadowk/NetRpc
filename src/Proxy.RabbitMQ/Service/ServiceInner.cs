...
namespace RabbitMQ.Base
{
    public sealed class ServiceInner : IDisposable
    {
        ...
        public void CreateChannel()
        {
            ...
            {
                using var session = new CallSession(_connect, _mainModel, e, _logger);
                await OnReceivedAsync(new EventArgsT<CallSession>(new CallSession(_connect, _mainModel, e, _logger)));
            };
        }
